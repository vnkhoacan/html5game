...
game.States.play = function(){
	...
	this.checkFly = function () {
		if (!this.addLifeButton || !this.addLifeButton.input.pointerOver()) {
			this.fly();
		}
	}
	...
	this.statrGame = function(){
		...
		this.readyText.destroy();
		this.playTip.destroy();
		game.input.onDown.add(this.checkFly, this);
	...
	this.stopGame = function(){
		...
		game.input.onDown.remove(this.checkFly,this);
		game.time.events.stop(true);
	}
